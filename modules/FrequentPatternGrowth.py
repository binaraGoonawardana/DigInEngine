...
def loadDataSet():
    return[['Bread', 'Milk'],['Bread', 'Diapers', 'Beer', 'Eggs'],['Milk', 'Diapers', 'Beer', 'Cola'],['Bread', 'Milk', 'Diapers', 'Beer'],['Bread','Milk', 'Diapers', 'Cola']]
...
if __name__ == '__main__':
    ...
    result = []
    for itemset, support in find_frequent_itemsets(transactions, 0, True):
