...
def store_datasource_config(self):
    ...
    if self.ds_config_id is None:
        ...
        print DbSourceID
        try:
            query = CC.insert_data([{'ds_config_id':DbSourceID,'connection_type':self.connectiontype,
            ...
            return cmg.format_response(True,query,"Successfully Inserted")
        ...
        try:
            query=CC.update_data('digin_data_source_config','WHERE ds_config_id ={0}'.format(self.ds_config_id),
            ...
            return cmg.format_response(True,query,"Successfully Updated")
...
def get_datasource_config(user_id, domain):
    ...
    try:
        query="SELECT ds_config_id,connection_type,connection_name,host_name,database_name,user_name,port,password,others " \
              ...
              "where b.user_id='{0}' AND b.domain='{1}'".format(user_id,domain)
