...
def prptConfig(database, user_id, domain):
    for filename in FilesNames:
        ...
        zip = zipfile.ZipFile(prpt_path+'/'+filename+'.prpt', 'a')
        zip.write(User_Reports_path+'/ReportSourceFile/'+filename+'/translations.properties','translations.properties',zipfile.ZIP_DEFLATED)
        zip.write(User_Reports_path+'/ReportSourceFile/'+filename+'/styles.xml','styles.xml',zipfile.ZIP_DEFLATED)
        zip.write(User_Reports_path+'/ReportSourceFile/'+filename+'/settings.xml','settings.xml',zipfile.ZIP_DEFLATED)
        zip.write(User_Reports_path+'/ReportSourceFile/'+filename+'/mimetype','mimetype',zipfile.ZIP_DEFLATED)
        zip.write(User_Reports_path+'/ReportSourceFile/'+filename+'/meta.xml','meta.xml',zipfile.ZIP_DEFLATED)
        zip.write(User_Reports_path+'/ReportSourceFile/'+filename+'/dataschema.xml','dataschema.xml',zipfile.ZIP_DEFLATED)
        zip.write(User_Reports_path+'/ReportSourceFile/'+filename+'/datadefinition.xml','datadefinition.xml',zipfile.ZIP_DEFLATED)
        zip.write(User_Reports_path+'/ReportSourceFile/'+filename+'/content.xml','content.xml',zipfile.ZIP_DEFLATED)
        zip.write(User_Reports_path+'/ReportSourceFile/'+filename+'/layout.xml','layout.xml',zipfile.ZIP_DEFLATED)
        zip.write(User_Reports_path+'/ReportSourceFile/'+filename+'/datasources/compound-ds.xml','datasources/compound-ds.xml',zipfile.ZIP_DEFLATED)
        zip.write(User_Reports_path+'/ReportSourceFile/'+filename+'/datasources/sql-ds.xml','datasources/sql-ds.xml',zipfile.ZIP_DEFLATED)
        zip.write(User_Reports_path+'/ReportSourceFile/'+filename+'/META-INF/manifest.xml','META-INF/manifest.xml',zipfile.ZIP_DEFLATED)
        zip.close()
